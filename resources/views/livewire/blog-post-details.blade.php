        ...
        <form wire:submit="save">
            <div class="space-y-12 sm:space-y-16">
                <div>
                    ...
                    <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
                        <label for="comment" class="block text-sm font-medium leading-6 text-gray-900 sm:pt-1.5">Comment</label>
                        <div class="mt-2 sm:col-span-2 sm:mt-0">
                            <textarea id="comment" name="comment" wire:model="comment" rows="10" class="block w-full max-w-2xl rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"></textarea>
                            <p class="mt-3 text-sm leading-6 text-gray-600">Write your comment here.</p>
                        </div>
                    </div>
                </div>
